...
if(os.path.isfile('Test/TestOS/test.txt')):
    os.remove('Test/TestOS/test.txt')

if(os.path.isdir('Test/TestOS')):
    os.rmdir('Test/TestOS')

os.mkdir('Test/TestOS')
os.chdir('Test/TestOS')    # 设置工作目录
fo = open('test.txt', 'w+')
fo.write('xxxxx\nyyyyy\n')
