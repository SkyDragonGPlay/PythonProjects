...
def unpack_apk(sourceFilePath):
    ...
    # 文件名
    fileNameWithoutExt = common.utils.getFileNameWithoutExtention(zipFile.filename)

    # 目标路径
    destDir = os.path.join(fileDir, fileNameWithoutExt)
    
    try:
        common.utils.removeDirRecursive(destDir)
        os.mkdir(destDir)
    ...
    for file in zipFile.namelist():
        ...
        # 文件名
        itemFileName = common.utils.getFileName(file)
